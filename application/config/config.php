...
|
*/
$config['base_url'] = 'http://localhost/tree-manager/';
...
$config['selected_theme'] = 'tspace';
$config['theme_abs_path'] = $config['base_url'].'assets/themes/'.$config['selected_theme'];

define('IMAGES_PATH', $config['theme_abs_path'].'/img/' );
